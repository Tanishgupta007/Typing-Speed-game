...
words=['the','apple', 'mango','be','to','have','not','about','would','which','time','know','our','people','just','look','after','fall','house', 'grapes', 'fan', 'laptop', 'mobile', 'Hat', 'Rat','boy','next','paper', 'follow', 'school', 'head', 'watch', 'wood','just','often', 'point','began','who', 'answer','year', 'mother', 'eat', 'are', 'could','song','put','air','study','before','study','car','through']
def labelSlider():
...
labelSlider()
random.shuffle(words)
wordlabel = Label(root, text=words[0], font=('arial', 40, 'italic bold'), bg='powder blue', fg='red')
...
scorelabelcount= Label(root, text=score, font=('arial', 30, 'italic bold'), bg='powder blue', fg='blue')
